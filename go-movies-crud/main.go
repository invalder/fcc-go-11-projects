...
func (m *Movie) Modify(isbn string, title string, firstName string, lastName string) {
	m.Isbn = isbn
	m.Title = title
	m.Director.Modify(firstName, lastName)
}

func (d *Director) Modify(firstName string, lastName string) {
